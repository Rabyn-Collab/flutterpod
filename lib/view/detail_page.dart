...
import 'package:flutterpod/common_widgets/snack_show.dart';
...
final commentController = TextEditingController();
  ...
  Widget build(BuildContext context, ref) {
    ...
    return Scaffold(
        body: ListView(
          children: [
            Image.network(post.imageUrl, height: 300, fit: BoxFit.cover,),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  posts.when(
                      data: (data){
                        final postRelated = data.firstWhere((element) => element.postId == post.postId);
